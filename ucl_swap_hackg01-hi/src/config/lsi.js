const Lsi = {
  ...
  about: {
    header: {
      cs: "O aplikaci uclSwap",
      en: "About application uclSwap",
    },
    creatorsHeader: {
      cs: "Tvůrci aplikace",
  ...
  unauthInit: {
    buyYourOwn: {
      cs: "Můžete si koupit vlastní uclSwap.",
      en: "You can buy your own uclSwap.",
    },
    notAuthorized: {
      cs: "Nemáte právo inicializovat tuto aplikaci uclSwap.",
      en: "You don't have rights to initialize this uclSwap.",
    },
  },
